...
parser.add_argument('--model_path', type = str, default = '../src/models/',
...
# 4d data
data_input = tf.Variable(tf.ones(shape=[step_max, sensor_n, sensor_n, scale_n]),dtype=tf.float32)
#tf.Variable(tf.ones(shape=[None, self._num_states]), dtype=tf.float32)
